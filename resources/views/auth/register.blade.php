                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" name="whatsapp" id="whatsapp"
                                                placeholder="08xxxxxxxxxxxx" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control" name="password" id="password"
                                                value="" placeholder="Kata Sandi" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control" name="password_confirmation" id="password-confirmation"
                                                value="" placeholder="Konfirmasi Kata Sandi" required>
                                            <label for="password" class="form-label">Konfirmasi Kata Sandi</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="d-grid">
                                            <button class="btn btn-primary btn-lg register" type="button" data-url="{{ route('auth.register') }}"><span>Daftar</span></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
